...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    ChatBot _localBot("../images/chatbot.png");
    // SetChatbotHandle(&_localBot);
    _localBot.SetChatLogicHandle(this);
    _localBot.SetRootNode(rootNode);
    rootNode->MoveChatbotHere(std::move(_localBot));
